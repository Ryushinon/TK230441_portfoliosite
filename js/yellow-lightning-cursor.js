/**
 * Yellow Lightning Cursor VFX
 * Creates a yellow lightning effect around the mouse cursor using HTML5 Canvas.
 * Customized for Lightning Slash page.
 */

(function () {
    // Create Canvas Element
    const canvas = document.createElement('canvas');
    canvas.id = 'yellow-lightning-vfx-canvas';
    ...
    class Bolt {
        constructor(x, y) {
            ...
            // Generate yellow colors 
            // Primarily bright yellow, sometimes white-yellow
            const colors = ['#FFFF00', '#FFEA00', '#FFD700', '#FFFACD'];
